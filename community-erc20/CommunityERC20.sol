...
contract CommunityERC20 {
     ...
     */
    function getTotalCommunity() public view returns(uint) {
    ...
    function addCommunity(address newCommunity) public returns (bool) {
        require(communityIndex[newCommunity] == 0, "Error:Community already registered");
     ...
     */
    function findCommunityIndex(address newCommunity) public view returns (uint) {
     ...
     */
    function getAddressFromIndex(uint index) public view returns (address) {
     ...
     */
    function getLastArrayIndex(address owner) public view returns(uint[2] memory) {
     ...
     * @return true.
     */
    function loopAndTransfer(uint256 amount, address receiver) public returns (bool) {
        Internal memory c;
        ...
        while (amount > 0) {
            ...
            if (c.currentBalance <= amount) {
                ...
                // how many arrays shifted in receiver 'balance[address]'.
                c.indexDepth++;
